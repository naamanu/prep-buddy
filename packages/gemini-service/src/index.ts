...
export class GeminiService {
    ...
    async generateInterviewQuestions(
        ...
        // Calculate approximate question count based on duration
        // Assume ~4-6 minutes per question with follow-ups
        const targetQuestions = Math.max(3, Math.floor(durationMinutes / 5));
